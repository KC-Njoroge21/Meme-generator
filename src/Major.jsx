    ...
    <main>
      <div className="grid gap-6 grid-cols-2 p-8">
        <div className="flex flex-col justify-center gap-3">
          ...
          <input value={meme.topText} onChange={handleChange} className="border-2 p-2 rounded-lg border-gray-300" type="text" id="topText" name="topText" placeholder="Shut up" />
        </div>
        <div className="flex flex-col justify-center gap-3">
          <label className="font-semibold text-gray-600"  htmlFor="bottomText">Botom text</label>
          <input value={meme.bottomText} onChange={handleChange}  className="border-2 p-2 rounded-lg border-gray-300" type="text" id="bottomText" name="bottomText" placeholder="And take my money" />
        </div>
      ...
      <div className="bg-amber-800 w-1/2 h-[400px] mx-auto relative flex justify-center ">
        ...
        <span className="absolute bottom-0 text-white font-semibold text-4xl uppercase">{meme.bottomText}</span>
